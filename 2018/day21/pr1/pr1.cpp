...
int main(int argc, char** argv){
    ...
    while (ip < size_program){
        ...
        num_instructions++;
        // the program halts when reaches instruction 28 if registers 0 and
        // 3 are equal
        if (ip == 28) break;
    }
    std::cout << "Minimum value of register 0 is " << register_array[3] << std::endl;
}
