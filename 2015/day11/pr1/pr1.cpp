...
int main(int argc, char** argv){
    ...
    /*
    std::cout << "This should be false: " << is_valid_password("hijklmmn") << std::endl;
    std::cout << "This should be false: " << is_valid_password("abbceffg") << std::endl;
    std::cout << "This should be false: " << is_valid_password("abbcegjk") << std::endl;
    std::cout << "This should be true: " << is_valid_password("abcdffaa") << std::endl;
    std::cout << "This should be true: " << is_valid_password("ghjaabcc") << std::endl;
    */
}
